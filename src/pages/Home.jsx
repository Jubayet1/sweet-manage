		...
		<section className="dark:bg-gray-900 dark:text-gray-100">
			<div className="container mx-auto flex flex-col items-center px-4 py-16 text-center md:py-32 md:px-10 lg:px-32 xl:max-w-3xl">
				...
				<div className="flex flex-wrap justify-center">
					{!currentUser ? <><Link to="signin" className="px-8 py-3 m-2 text-lg font-semibold rounded bg-violet-400 text-gray-900">Sign In</Link>
						<Link to="signup" className="px-8 py-3 m-2 text-lg border rounded text-gray-900 border-gray-700">Sign Up</Link></> : <Link to="profile" className="px-8 py-3 m-2 text-lg font-semibold rounded bg-violet-400 text-gray-900">Go To Profile</Link>}
				</div>
			</div>
		</section>
